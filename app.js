...
const squareArr = numbers.map((number) => number * number);
...
console.log(alphabets.join(""));
                                            // using reduce
console.log(alphabets.reduce((accumulator, currentValue) => accumulator+currentValue));


//Challenge 4: Given an array of numbers, write a code to return a first even number using find method.
const number = [1, 2, 3, 4, 5];
console.log(number.find((number)=>number%2==0));
...
console.log(ranks.findIndex((index)=> index==7))
...
console.log(marks.some((mark)=> mark <45))
...
// 2
let checkbike= person.vehicles.hasOwnProperty("plane") ;
let checkhouse= person.hasOwnProperty("house")
